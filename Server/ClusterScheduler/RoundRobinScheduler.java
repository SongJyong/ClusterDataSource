...
public class RoundRobinScheduler implements Scheduler{
    private AtomicInteger index = new AtomicInteger(); // 골고루 분배할 수 있게 내부에서 순서를 가지고 있어야 함.
    @Override
    public int getScheduleIndex(){
        ...
        int ind = index.getAndIncrement()%len; // availableList 사이즈가 일정하지 않기 때문에 항상 확인하고 참조
